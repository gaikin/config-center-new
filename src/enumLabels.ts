...
export const pendingTypeLabelMap: Record<GovernancePendingItem["pendingType"], string> = {
  DRAFT: "待发布",
  EXPIRING_SOON: "即将到期",
...
export const auditActionLabelMap: Record<GovernanceAuditLog["action"], string> = {
  PUBLISH: "发布",
  DISABLE: "停用",
  ROLLBACK: "回滚",
  RISK_CONFIRM: "风险确认",
